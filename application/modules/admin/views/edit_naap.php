	      	...
	      	<form id="form-edit" action="<?php echo base_url('admin/edit_naap/'.$this->uri->segment(3).'/'.$this->uri->segment(4).''); ?>" class="form-horizontal" method="post">
	      		<fieldset>
	      			...
	      			<div class="row">
	      				<div class="span12">
	      					<div class="control">
	      					<select id="naap_type" name="naap_type" style="float: right;">
							  <option value="" selected>Select Type</option>
							  <option value="Suit" <?php if($n->naap_type == 'Suit'){ echo 'selected = "selected"';} ?>>Suit</option>
							  <option value="Coat" <?php if($n->naap_type == 'Coat'){ echo 'selected = "selected"';} ?>>Coat</option>
							  <option value="Waist Coat" <?php if($n->naap_type == 'Waist Coat'){ echo 'selected = "selected"';} ?>>Waist Coat</option>
							  <option value="Paint" <?php if($n->naap_type == 'Paint'){ echo 'selected = "selected"';} ?>>Paint</option>
							</select>
							</div>
	      				</div>
	      			</div>
	      			...
	      			<textarea style="width:100%;height: 50px;margin-top: 20px;" class="form-control" rows="6" cols="6" name="comment" placeholder="Additional Comment"><?php echo $n->comment; ?></textarea>
